...
class NavigationController extends Controller
{
    ...
    {
        $this->middleware('can:read configuration');
    ...
    public function index(Request $request)
    {
        ...
        return view('configuration.navigation', compact('title'));
    }
    ...
    public function create()
    {
        ...
        return view('configuration.navigation-form', compact('navigation', 'parent', 'role'));
    }
