<div class="card-body">
    <form id="form-modalAction" class="form"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="type_menu" class="form-label">نوع القائمة</label>
            ...
            <div class="col-md-6 {{ $navigation->type_menu == 'child' ? '' : 'd-none' }}" id="main_menu">
                <div class="mb-3">
                    <label for="main_menu" class="form-label">القائمة الرئيسية</label>
                    <select class="form-select select2" name="main_menu" id="main_menu"
                        aria-label="Default select example">
                        <option value="" selected>اختر من القائمة</option>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="أدخل هنا" name="name" class="form-control" id="name"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="أدخل هنا" name="url" class="form-control" id="url"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="أدخل هنا" name="icon" class="form-control" id="icon"
                        value="{{ $navigation->icon }}">
                    <small class="text-muted">يدعم Font Awesome 6.5.2</small>
                    <small class="text-danger" id="icon-error"></small>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="sort" class="form-label">الموضع</label>
                    <input type="text" placeholder="أدخل هنا" name="sort" class="form-control" id="sort"
