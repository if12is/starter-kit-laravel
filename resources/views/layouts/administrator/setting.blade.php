<div class="settings">
    ...
    <div class="settings-content">
        <ul>
            ...
            <li class="rtl-direction">
                <div class="rtl-direction-wrapper">
                    <div class="form-check form-switch lg">
                        <label class="form-check-label" for="settingsRTL">RTL Direction</label>
                        <input class="form-check-input toggle-settings" name="RTL" type="checkbox" id="settingsRTL">
                    </div>
                </div>
            </li>
        </ul>
